...
public class UsersRepositoryJdbcImpl implements CrudRepository {
    ...
    private static final String SQL_SELECT_ALL_FROM_USERS_BY_AGE = "select * from users where age=";
    ...
    public List<User> findAllByAge(Integer age) {
        ...
        try{
            ...
            ResultSet resultSetAge = statement.executeQuery(SQL_SELECT_ALL_FROM_USERS_BY_AGE + age.toString());
